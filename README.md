...
**Postcondizioni**: Il nuovo appuntamento è stato inserito nel sistema ed il receptionist può essere collegato: 
1) Alla pagina dei dettagli del medico [ */medico/{id}* ], se il nuovo appuntamento è stato creato a partire dall'associazione del medico.
2) Alla pagina dei dettagli del paziente [ */paziente/{id}* ], se il nuovo appuntamento è stato creato a partire dall'associazione del paziente.
