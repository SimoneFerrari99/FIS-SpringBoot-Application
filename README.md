...
**Postcondizioni**: Il nuovo appuntamento è stato inserito nel sistema ed il receptionist è collegato alla pagina dei dettagli dell'appuntamento appena aggiunto [ */appuntamento/{id}* ]
